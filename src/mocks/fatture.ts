...
const CLI = {
  condominioBattisti: 'cli-01',
  comuneCasalecchio: 'cli-02',
  agricolaFerrari: 'cli-03',
  villaMonteveglio: 'cli-04',
  condominioLeQuerce: 'cli-05',
  hotelSanLuca: 'cli-06',
  parrocchiaSantAgata: 'cli-07',
  gandolfiPrivato: 'cli-08',
  logisticaEmiliana: 'cli-09',
} as const;
...
export const fattureMock: Fattura[] = [
  ...
  fattura({
    ...
    numero: num(6),
    tipo: 'unica',
    clienteId: CLI.condominioLeQuerce,
  ...
  fattura({
    ...
    numero: num(8),
    tipo: 'unica',
    clienteId: CLI.logisticaEmiliana,
  ...
  fattura({
    ...
    numero: num(9),
    tipo: 'acconto',
    clienteId: CLI.parrocchiaSantAgata,
    commessaId: 'cm-008',
    dataEmissione: giorni(-8),
    dataScadenza: giorni(22),
    note: 'Acconto 40% alla conferma dei lavori sul sagrato.',
    righe: [{ descrizione: 'Acconto 40% su messa in sicurezza dei cipressi del sagrato', quantita: 1, prezzoUnitario: 760 }],
  }),
  fattura({
    id: 'ft-010',
    numero: num(10),
    tipo: 'unica',
    clienteId: CLI.villaMonteveglio,
    ...
    datiFE: {
      ...
      pecDestinatario: 'villamonteveglio@pec.it',
      tipoDocumento: 'TD01',
      regimeFiscale: 'RF01',
    },
  }),
  ...
  fattura({
    ...
    clienteId: CLI.parrocchiaSantAgata,
    commessaId: 'cm-008',
    righe: [{ descrizione: 'Saldo messa in sicurezza dei cipressi del sagrato', quantita: 1, prezzoUnitario: 1_140 }],
